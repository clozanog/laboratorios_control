...
class Node():
    ...
    def initParameters(self):
        ...
        self.topic_ang = "/angular_g1"
        self.topic_lin = "/linear_g1"
        ...
        self.rate = self.rospy.Rate(30)#Frecuencia a la que se va ejecutar el nodo
